...
default_tasks = [
    "صلاة الفجر", "اذكار بعد صلاة الفجر", "الدعاء بعد صلاة الفجر", "اذكار الصباح",
    "صلاة الضحى", "الدعاء بعد صلاة الضحى", "الرقية الشرعية", "صلاة الظهر فرض وسنة",
    "اذكار بعد صلاة الظهر", "الدعاء بعد صلاة الظهر", "نصف جزء من القرآن الفترة النهارية",
    "استغفار وتسبيح وتهليل وتكبير بشكل كبير", "صلاة العصر", "اذكار بعد صلاة العرصر",
    "الدعاء بعد صلاة العصر", "اذكار المساء", "صلاة المغرب والسنة", "اذكار بعد صلاة المغرب",
    "الدعاء بعد صلاة المغرب", "صلاة العشاء والسنة", "اذكار بعد صلاة العشاء",
    "الدعاء بعد صلاة العشاء", "صلاة القيام على الأقل 4+ ركعات",
    "نصف جزء من القرآن الفترة الليلية", "أستغفار/تسبيح/تهليل/تكبير بشكل كبير",
    "الدعاء", "الشفع والوتر"
]
